...
async function getCurrencies() {
  const response = await fetch(
    'https://openexchangerates.org/api/latest.json?app_id=fc5da390aa70424e8b673eaee64a44f0&symbols'
  ); //Получаем данные, которые вернет fetch()
  ...
  ratest.USD = result.rates.RUB / result.rates.USD;
  ratest.EUR = result.rates.RUB / result.rates.EUR;
  ratest.GBP = result.rates.RUB / result.rates.GBP;
